...
# Device report: 30 days, by device category
device_rows = fetch_report(['DEVICE_CATEGORY_NAME'], [
    'AD_SERVER_IMPRESSIONS', 'AD_SERVER_CLICKS', 'AD_SERVER_CPM_AND_CPC_REVENUE'
], today - datetime.timedelta(days=29), today)

# GEO report: 30 days, by country
geo_rows = fetch_report(['GEO_COUNTRY_NAME'], [
    'AD_SERVER_IMPRESSIONS', 'AD_SERVER_CLICKS', 'AD_SERVER_CPM_AND_CPC_REVENUE'
], today - datetime.timedelta(days=29), today)
